...
function toggleCapture() {
  ...
  browser.storage.local.set({ captureEnabled: captureEnabled });
}
...
function addToRecentFolders(folder) {
  ...
  // Save to storage
  browser.storage.local.set({ recentFolders: recentFolders });
...
function loadRecentFolders() {
  browser.storage.local.get('recentFolders').then(result => {
